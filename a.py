...
while amountdone < togen:
    username = str(''.join(random.choices(
        string.ascii_letters + string.digits, k=usernamelen)))
    password = str(''.join(random.choices(
        string.ascii_letters + string.digits, k=passwordlen)))
